//Canvas ist das Objekt indem sich das Spiel befindet
...
function vec2(x, y) 
{                           //diese function gibt ein Objekt zurück 
    return {x: x, y: y}
}
...
function Ball(pos, velocity, radius) 
{
    ...
    this.draw = function () {
        ctx.fillStyle = "#1B03A3";
        ctx.strokeStyle = "#1B03A3";
        ctx.beginPath();
...
function respawnBall(ball)
{
    if (ball.velocity.x > 0)
    {
        ...
        ball.pos.y = (Math.random() * (canavs.height - 100)) + 100;
    }
...
function gameLoop() //Endlosschleife für movement des Balles
{
...
let gameCanvas = document.getElementById("canvasScreen");
